...
const BookTicket = () => {
  ...
  const handleData = (e) => {
    ...
    const url = `https://dhakabusserver.onrender.com/getSeat/${data?.from}&&${data?.to}&&${data?.date}&&${data?.busType}&&${data?.schedule}`;
    setLoadSeat(true)
  ...
  const handleBookTicket = () => {
    ...
    if (cardNumber === "424242424242" && cardPass === "123456") {
      ...
      fetch("https://dhakabusserver.onrender.com/book-ticket", {
        method: "POST",
      ...
      fetch("https://dhakabusserver.onrender.com/book-my-ticket", {
        method: "POST",
        headers: { "content-type": "application/json" },
        body: JSON.stringify(bookedTicketUsingUserInformation),
      })
